...
;; use the Euclidean algorithm to produce the GCD of two given naturals
;; CONSTRAINT: both naturals are > 0
...
(define (euclid n1 n2)
  ...
  ;; trivial: n1 = n2
  ;; reduction: replace the larger of n1, n2 with abs. of n1 - n2
  ;; argument: since both n1 and n2 are >= 1, reducing either one of them
  ;;           will eventually lead to them being equal (worst case being they
  ;;           both equal 1)
  (cond [(= n1 n2) n1]
        [else
         (if (> n1 n2)
