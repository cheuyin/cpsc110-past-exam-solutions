...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname mt1-p7-starter) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require spd/tags)
(require 2htdp/image)
...
;; made your choice.
;; 
;; Chose enumeration because a driver license class is an atomic-distinct value
...
;;
;; Replace the ??? with the FIRST data definition form in the list
...
;; made your choice.
;; 
;; list of items (self-ref) and each item is compound data w/name and quantity
