...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname 2020W1-MT1-P4-solution) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require spd/tags)
(require 2htdp/image)
