...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname 2020W1-F-P2-solution) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #t)))
(require spd/tags)
(require 2htdp/image)
