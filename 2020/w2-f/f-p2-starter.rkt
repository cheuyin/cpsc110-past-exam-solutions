...
;(@template encapsulated RenderTree (listof RenderTree))
...
;; produce simple rendering of given rendertree
(check-expect (render RT0) (square 20 "solid" "red"))
(check-expect (render RT2) (above RT0 (beside RT0 RT1 RT0)))
(check-expect (render RT3) (above (render RT2) (beside RT1 RT0 RT1)))
(check-expect (render RT4) (beside (render RT2) (render RT3) (render RT2)))
(check-expect (render RT5) (square 20 "solid" "red"))

; (define (render rt) empty-image)  ; stub

(@template RenderTree (listof RenderTree) encapsulated)
