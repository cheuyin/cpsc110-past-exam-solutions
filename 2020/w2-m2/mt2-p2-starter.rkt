...
(define my-answer-question-1 "b") ;replace "x" with "a" or "b"
...
(define my-answer-question-2 "b") ;replace "x" with "a" or "b"
...
(define my-answer-question-3 "a") ;replace "x" with "a" or "b"
...
(define my-answer-question-4 "e") ;replace "x" with "a", "b", "c", "d", or "e"
...
(define my-answer-question-5 12)   ;replace 0 below with the correct number
